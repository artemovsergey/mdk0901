...
Лекция 8. CSS Layout: Float(float left, right; clearfix;box-sizing:border-box), 
Практическая работа 6. Компоновка карточки товара на Float

Лекция 9. Flexbox. Презентация
