...
- Практическая работа. Верстка простой страницы
- Лекция 6. HTML: форма,семантика,таблицы
- Практическая работа. Создание формы регистрации
- Самостоятельная работа. Разметка личной страницы
- Лекция 7. CSS: селекторы,каскад,наследование
- Практическая работа. Стилизация страницы
- Лекция 8. CSS: Flexbox, Grid, адаптивная верстка
- Практическая работа. Создание адаптивного макета
...
- Лекция 11. Основые Angular, структура проекта
...
# Модуль. HttpClient
- Лекция: Получение данных по сети
